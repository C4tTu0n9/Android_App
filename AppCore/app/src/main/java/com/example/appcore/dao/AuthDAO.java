...
import com.example.appcore.ui.activities.admin.AdminStaticActivity;
import com.example.appcore.ui.activities.login.LoginActivity;
import com.example.appcore.ui.onboarding.OnboardingActivity;
...
import com.example.appcore.data.remote.FirebaseAuthManager;

public class AuthDAO {
    private final FirebaseAuth firebaseAuth;

    public AuthDAO() {
        // Trả về FirebaseAuth duy nhất, theo kiểu Singleton
                            ...
                            userDAO.getUserById(userId, user -> {
                                if (user != null) {
                                   ...
                                   if (user.getRole() == 1) { // Role = 1 (admin) -> CategoryActivity
                                        ...
                                        intent = new Intent(context, AdminStaticActivity.class);
