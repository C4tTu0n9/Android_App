...
public class StatisticRevenueActivity extends AppCompatActivity {
    private static final String TAG = "StatisticRevenueActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_statistic_revenue);
        ...
        transactionDAO.getRevenueByTimeRange(startTime, endTime, new TransactionHistoryDAO.TransactionHistoryCallback() {
            ...
            public void onFailure(String error) {
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(StatisticRevenueActivity.this, 
    ...
    private void updateMovieDistributionChart() {
        ...
        PieDataSet dataSet = new PieDataSet(entries, "Phân bố doanh thu theo phim");
